# Current-component bridge: divider

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `divider` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/divider` implementation.
...
3. Render the current `divider` component and capture color/typography/density states relevant to the old aggregate.
