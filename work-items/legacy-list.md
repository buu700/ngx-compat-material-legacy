...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-list |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-list/public-api.ts |
| Source closure to inspect | legacy-core line and pseudo-checkbox; selection-list/list-option |
| Current public candidates | SelectionModel, keyboard managers, focus and bidi public APIs |
| Motion audit | selection/focus cleanup |
| Upstream recipe IDs | API-02 |

## Concrete preservation checks

one/two/multi-line, avatars/icons, selection-list CVA, disabled/keyboard, dynamic lines.

**Do not take this shortcut:** Preserve mat-list-item-content and mat-list-text hierarchy; current line helper docs-private status matters.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-list.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
