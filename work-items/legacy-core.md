...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-core |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-core/public-api.ts |
| Source closure to inspect | historical option/optgroup implementation and 48 aliases |
| Current public candidates | Public Material/CDK primitives according to delegation ledger |
| Motion audit | engine-free constants, option/ripple lifecycles |
| Upstream recipe IDs | MOTION-01 API-02 |

## Concrete preservation checks

alias identity, option selection/keyboard, ripples, line counting, date modules.

**Do not take this shortcut:** Never forward current core wholesale. Preserve old option DOM and conditional pseudo-checkbox/ripple presentation.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-core.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
