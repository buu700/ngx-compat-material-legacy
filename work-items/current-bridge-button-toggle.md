# Current-component bridge: button-toggle

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `button-toggle` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/button-toggle` implementation.
...
3. Render the current `button-toggle` component and capture color/typography/density states relevant to the old aggregate.
