...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-snack-bar |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-snack-bar/public-api.ts |
| Source closure to inspect | old service/ref/container/config and simple action content |
| Current public candidates | Overlay/Portal, LiveAnnouncer, breakpoint/focus public primitives |
| Motion audit | enter/exit callbacks and timer cleanup |
| Upstream recipe IDs | ANIM-05 |

## Concrete preservation checks

duration/action dismiss, queue replacement, announcements, panel classes, handset positioning.

**Do not take this shortcut:** Keep old container/action layout; current source uses different visual markup. Test dismissal during entrance.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-snack-bar.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
