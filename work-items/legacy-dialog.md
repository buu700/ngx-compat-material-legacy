...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-dialog |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-dialog/public-api.ts |
| Source closure to inspect | old dialog base/container/ref/config; public CDK dialog integration |
| Current public candidates | Dialog/Overlay/Portal, focus trapping and restoration public APIs |
| Motion audit | open/close lifecycle exactly once |
| Upstream recipe IDs | ANIM-08 ROB-05 ROB-06 |

## Concrete preservation checks

nested dialogs, custom container/panel classes, beforeClosed/afterClosed, focus/scroll strategies.

**Do not take this shortcut:** Preserve mat-dialog-container/content/actions structure; lifecycle/focus must survive cancellation and disabled motion.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-dialog.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
