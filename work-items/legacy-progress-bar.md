...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-progress-bar |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-progress-bar/public-api.ts |
| Source closure to inspect | legacy progress base and color/determinate behavior |
| Current public candidates | Angular/coercion/platform as needed |
| Motion audit | CSS animations and animationEnd output |
| Upstream recipe IDs | THEME-01 |

## Concrete preservation checks

determinate/buffer/query/indeterminate, value clamps, RTL, ARIA.

**Do not take this shortcut:** Preserve track/fill/buffer classes and keyframe behavior. Motion exceptions must not mask color or sizing changes.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-progress-bar.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
