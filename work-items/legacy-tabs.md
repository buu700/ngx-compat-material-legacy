...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-tabs |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-tabs/public-api.ts |
| Source closure to inspect | old group/header/body/portal/nav and ink bar/private bases |
| Current public candidates | Portal, scrolling, Directionality, public focus/keyboard helpers |
| Motion audit | body motion, interruption and animationDone |
| Upstream recipe IDs | ANIM-03 |

## Concrete preservation checks

dynamic height, lazy/preserved content, nav panel, header pagination, ARIA, RTL.

**Do not take this shortcut:** Keep mat-tab-body/content/label-container structure. Avoid new wrapper elements to ease height animation.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-tabs.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
