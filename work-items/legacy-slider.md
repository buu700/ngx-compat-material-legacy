...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-slider |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-slider/public-api.ts |
| Source closure to inspect | complete legacy slider implementation; old single-control API |
| Current public candidates | Directionality, platform, focus, coercion |
| Motion audit | thumb label and pointer state motion |
| Upstream recipe IDs | THEME-01 |

## Concrete preservation checks

min/max/step/value, tickInterval, thumbLabel, vertical/invert, pointer/keyboard, CVA.

**Do not take this shortcut:** Do not import modern thumb-input/range slider API. Test vertical/invert and old geometry carefully.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-slider.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
