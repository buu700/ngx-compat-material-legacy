# Current-component bridge: toolbar

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `toolbar` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/toolbar` implementation.
...
3. Render the current `toolbar` component and capture color/typography/density states relevant to the old aggregate.
