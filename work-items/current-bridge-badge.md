# Current-component bridge: badge

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `badge` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/badge` implementation.
...
3. Render the current `badge` component and capture color/typography/density states relevant to the old aggregate.
