# Current-component bridge: tree

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `tree` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/tree` implementation.
...
3. Render the current `tree` component and capture color/typography/density states relevant to the old aggregate.
