# Current-component bridge: bottom-sheet

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `bottom-sheet` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/bottom-sheet` implementation.
...
3. Render the current `bottom-sheet` component and capture color/typography/density states relevant to the old aggregate.
