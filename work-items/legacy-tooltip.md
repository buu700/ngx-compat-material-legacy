...
| Item | Starting point |
|---|---|
| Tagged directory | https://github.com/angular/components/tree/16.2.14/src/material/legacy-tooltip |
| Public API inventory anchor | https://raw.githubusercontent.com/angular/components/16.2.14/src/material/legacy-tooltip/public-api.ts |
| Source closure to inspect | old tooltip/popup bases; config; gesture handling |
| Current public candidates | AriaDescriber, Overlay, FocusMonitor, scroll/breakpoint/platform |
| Motion audit | show/hide and dispose timing |
| Upstream recipe IDs | ANIM-09 |

## Concrete preservation checks

touch/longpress, disabled, position/scroll, descriptions, show/hide delays.

**Do not take this shortcut:** Keep mat-tooltip panel/text constraints. Test detached triggers, nested themes and disabled/reduced motion.
...
Store exact source/target SHAs, changed files, commands/results and evidence locations in `compatibility/work-items/legacy-tooltip.json`. Proposed dependency candidates are not permission to claim runtime compatibility without tests.
