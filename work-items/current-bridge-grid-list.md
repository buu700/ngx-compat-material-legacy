# Current-component bridge: grid-list

## Historical responsibility

Material 16 `all-legacy-component-themes` included the ordinary `grid-list` theme alongside the legacy families. The compatibility facade must preserve the historical call/aggregate responsibility while the actual component remains the current official `@angular/material/grid-list` implementation.
...
3. Render the current `grid-list` component and capture color/typography/density states relevant to the old aggregate.
