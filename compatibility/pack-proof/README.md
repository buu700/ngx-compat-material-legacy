...
secondary entries: `legacy-button`, `legacy-form-field`, `legacy-input`,
`legacy-core` (option), `legacy-select`, plus the Sass root facade.
...
| `consumer-smoke-theme.css` | Cyph-like deep-purple 800 + overlay theme mixins |
| `inspect-packed-package.json` | Static inspector (LICENSE/schematics/remaining entries still open) |
