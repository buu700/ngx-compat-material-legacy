 ...
 *
 * Owned Material-16 `_MatTableDataSource` + paginator interfaces (removed from
 * Angular Material 22 public API; M22 MatTableDataSource is coupled to MatPaginator).
 */
