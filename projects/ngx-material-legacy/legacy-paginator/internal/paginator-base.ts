...
import {MatPaginatorIntl, MatPaginatorSelectConfig, PageEvent} from '@angular/material/paginator';
...
// Re-export PageEvent name used historically inside the base file body if referenced as local — body uses PageEvent.
